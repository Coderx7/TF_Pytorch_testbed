...
from official.simpnet import imagenet_main
...
# class BaseTest(tf.test.TestCase):
  ...
  # def _tensor_shapes_helper(self, dtype, with_gpu):
  ...
  #     initial_conv = graph.get_tensor_by_name('simpnet_model/initial_conv:0')
  #     max_pool = graph.get_tensor_by_name('simpnet_model/initial_max_pool:0')
  #     # block_layer1 = graph.get_tensor_by_name('simpnet_model/block_layer1:0')
  #     # block_layer2 = graph.get_tensor_by_name('simpnet_model/block_layer2:0')
  #     # block_layer3 = graph.get_tensor_by_name('simpnet_model/block_layer3:0')
  #     # block_layer4 = graph.get_tensor_by_name('simpnet_model/block_layer4:0')
  #     reduce_mean = graph.get_tensor_by_name('rsimpnet_model/final_reduce_mean:0')
  #     dense = graph.get_tensor_by_name('simpnet_model/final_dense:0')
  ...
  # def tensor_shapes_helper(self, with_gpu=False):
  #   self._tensor_shapes_helper(dtype=tf.float32, with_gpu=with_gpu)
  #   self._tensor_shapes_helper(dtype=tf.float16, with_gpu=with_gpu)
  ...
  # def _resnet_model_fn_helper(self, mode, dtype, multi_gpu):
  ...
  #   self._resnet_model_fn_helper(mode=mode, dtype=tf.float32,
  #                                multi_gpu=multi_gpu)
  #   self._resnet_model_fn_helper(mode=mode, dtype=tf.float16,
  #                                multi_gpu=multi_gpu)
  ...
  # def _test_imagenetmodel_shape(self):
  #   batch_size = 135
  #   num_classes = 246
  ...
  #   self._test_imagenetmodel_shape()
